...
-- {{{ Key bindings
globalkeys = my_table.join( -- Chromium
                 awful.key({modkey}, "w",
    ...
    -- Rofi / run a program
                 awful.key({modkey}, "r",
                           function() awful.util.spawn("rofi -show") end, {
        description = "Run program with rofi",
        group = "apps"
    }), -- Telegram
    awful.key({modkey}, "t",
              function() awful.util.spawn("telegram-desktop") end,
              {description = "telegram", group = "apps"}), -- Abre nautilus
    ...
    -- Abre microsoft teams
                 awful.key({modkey}, "c",
                           function() awful.util.spawn("teams") end, {
        description = "Microsoft teams / work",
        group = "apps"
    }), -- Abre Office
    ...
    -- super + shift + ...
                 ...
                 awful.key({modkey1, altkey}, "b",
                           function() awful.util.spawn(filemanager) end,
                           {description = filemanager, group = "alt+ctrl"}),

                 awful.key({modkey1, altkey}, "c",
                           function() awful.util.spawn("catfish") end,
                           {description = "catfish", group = "alt+ctrl"}),

                 awful.key({modkey1, altkey}, "i",
                           function() awful.util.spawn("nitrogen") end,
    ...
    -- Dynamic tagging
        ...
        awful.util.spawn_with_shell("python3 $HOME/.config/awesome/keyboard.py")
    end, {description = terminal, group = "super"}), awful.key({}, "Print",
                                                               function()
        awful.util.spawn_with_shell("flameshot gui")
    end, {description = terminal, group = "super"}), -- Standard program
    ...
    -- awful.key({ modkey1 }, "Up",
        ...
        awful.spawn
            .with_shell("python3 $HOME/.config/awesome/volume.py set +5%")
...
awful.rules.rules = {
    ...
    {rule = {class = "mpv"}, properties = {maximized = true}}, 
    ...
    -- Floating clients.
    {
        rule_any = {
            ...
            class = {
                "Arandr", "Arcolinux-welcome-app.py", "Blueberry", "Galculator",
                "Gnome-font-viewer", "Gpick", "Imagewriter", "Font-manager",
                "Kruler", "MessageWin", -- kalarm.
                "arcolinux-logout", "Peek", "Skype", "System-config-printer.py",
                "Sxiv", "Unetbootin.elf", "Wpa_gui", "pinentry", "veromix",
                "xtightvncviewer", "Xfce4-terminal"
            },
